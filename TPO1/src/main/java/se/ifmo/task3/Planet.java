...
public class Planet implements SpaceBody {
    ...
    public Planet(Coordinate coordinate, String name, Color color, int age, Size size) {
    ...
    public boolean equals(Object o) {
        ...
        return age == planet.age && Objects.equals(coordinate, planet.coordinate) && Objects.equals(Name, planet.Name) && color == planet.color && size == planet.size;
    }
