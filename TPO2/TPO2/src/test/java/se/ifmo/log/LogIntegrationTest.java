...
public class LogIntegrationTest {
    ...
    void testFunctionWithMocks(Double x, Double trueResult) {
        try {
            LogarithmicFunctionCalculator calculator = new LogarithmicFunctionCalculator(ln, log2, log3, log5);
    ...
    void testFunctionWithLn(Double x, Double trueResult) {
        try {
            LogarithmicFunctionCalculator calculator = new LogarithmicFunctionCalculator(new Ln(), log2, log3, log5);
            double result = calculator.checkAndCalculate(x, eps);
            assertEquals(trueResult, result, accuracy);
        } catch (ArithmeticException e) {
            assertEquals("x should be > 0", e.getMessage());
    ...
    void testFunctionWithLog2(Double x, Double trueResult) {
        try {
            LogarithmicFunctionCalculator calculator = new LogarithmicFunctionCalculator(new Ln(), new Log2(ln), log3, log5);
            double result = calculator.checkAndCalculate(x, eps);
            assertEquals(trueResult, result, accuracy);
        } catch (ArithmeticException e) {
            assertEquals("x should be > 0", e.getMessage());
    ...
    void testFunctionWithLog2Deeper(Double x, Double trueResult) {
        try {
            LogarithmicFunctionCalculator calculator = new LogarithmicFunctionCalculator(new Ln(), new Log2(new Ln()), log3, log5);
            double result = calculator.checkAndCalculate(x, eps);
            assertEquals(trueResult, result, accuracy);
        } catch (ArithmeticException e) {
            assertEquals("x should be > 0", e.getMessage());
    ...
    void testFunctionWithLog3(Double x, Double trueResult) {
        try {
            LogarithmicFunctionCalculator calculator = new LogarithmicFunctionCalculator(new Ln(), new Log2(new Ln()), new Log3(ln), log5);
            double result = calculator.checkAndCalculate(x, eps);
            assertEquals(trueResult, result, accuracy);
        } catch (ArithmeticException e) {
            assertEquals("x should be > 0", e.getMessage());
    ...
    void testFunctionWithLog3Deeper(Double x, Double trueResult) {
        try {
            LogarithmicFunctionCalculator calculator = new LogarithmicFunctionCalculator(new Ln(), new Log2(new Ln()), new Log3(new Ln()), log5);
            double result = calculator.checkAndCalculate(x, eps);
            assertEquals(trueResult, result, accuracy);
        } catch (ArithmeticException e) {
            assertEquals("x should be > 0", e.getMessage());
    ...
    void testFunctionWithLog5(Double x, Double trueResult) {
        try {
            LogarithmicFunctionCalculator calculator = new LogarithmicFunctionCalculator(new Ln(), new Log2(new Ln()), new Log3(ln), new Log5(ln));
            double result = calculator.checkAndCalculate(x, eps);
            assertEquals(trueResult, result, accuracy);
        } catch (ArithmeticException e) {
            assertEquals("x should be > 0", e.getMessage());
    ...
    void testFunctionWithLog5Deeper(Double x, Double trueResult) {
        try {
            LogarithmicFunctionCalculator calculator = new LogarithmicFunctionCalculator(new Ln(), new Log2(new Ln()), new Log3(new Ln()), new Log5(new Ln()));
            double result = calculator.checkAndCalculate(x, eps);
            assertEquals(trueResult, result, accuracy);
        } catch (ArithmeticException e) {
            assertEquals("x should be > 0", e.getMessage());
